...
c0=net.addController('c0', controller=RemoteController,ip='192.168.49.2', port=32313 )
...
snort_image="ciscotalos/snort3:latest"
#snort = net.addHost('snort', ip='10.0.1.8/24',mac="00:00:00:00:00:01")
snort = net.addDocker('snort', ip='10.0.1.8/24',mac="00:00:00:00:00:01",dimage=snort_image)
